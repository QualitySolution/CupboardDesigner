...
namespace CupboardDesigner
{
	public partial class AdminModePassword
	{
		...
		protected virtual void Build ()
		{
			...
			// Widget CupboardDesigner.AdminModePassword
			this.Name = "CupboardDesigner.AdminModePassword";
			this.WindowPosition = ((global::Gtk.WindowPosition)(4));
			// Internal child CupboardDesigner.AdminModePassword.VBox
			...
			this.label2.LabelProp = global::Mono.Unix.Catalog.GetString ("Для входа в административный\nрежим, введите пароль.");
			w1.Add (this.label2);
			...
			this.hbox1.BorderWidth = ((uint)(18));
			// Container child hbox1.Gtk.Box+BoxChild
			this.label3 = new global::Gtk.Label ();
			this.label3.Name = "label3";
			this.label3.Xalign = 1F;
			this.label3.LabelProp = global::Mono.Unix.Catalog.GetString ("Пароль:");
			...
			w5.Expand = false;
			w5.Fill = false;
			// Internal child CupboardDesigner.AdminModePassword.ActionArea
